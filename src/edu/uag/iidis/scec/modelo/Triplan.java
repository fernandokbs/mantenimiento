 ...
 * @version 1.0
 */
public class Triplan extends ClaseBase 
    ...
    public Triplan(Long id){
        this.id = id;
    }

    public Triplan(String nombre, String descripcion,Long poblacion,String coordenadas,String estado, String imagen, String pais, String moneda){
        this.nombre=nombre;
