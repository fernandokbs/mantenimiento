<!-- Inicio de còdigo para determinar el tiempo de procesamiento -->
	<%@ page import="java.util.*" %>
	<% long t1=System.currentTimeMillis(); %>
<!-- Fin de c�digo para determinar el tiempo de procesamiento -->
...
<!-- Inicio de c�digo para calcular y visualiza el tiempo de procesamiento -->
<p><%= System.currentTimeMillis()-t1 %>ms</p>
<!-- Fin de c�digo para calcular y visualiza el tiempo de procesamiento -->
